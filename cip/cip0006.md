...
Implementation is tracked as DO-work in backlog tasks:

- Existing umbrella task:
  - `backlog/features/2026-01-04_two-stage-cli-phase1.md`
- Decomposed Phase 1 tasks (2026-02-03):
  - `backlog/features/2026-02-03_lamd-cli-entrypoint.md`
  - `backlog/features/2026-02-03_interface-schema-compute-section.md`
  - `backlog/features/2026-02-03_lamd-talk-subcommand.md`
  - `backlog/features/2026-02-03_lamd-cv-subcommand.md`
  - `backlog/features/2026-02-03_lamd-cli-tests.md`
  - `backlog/documentation/2026-02-03_lamd-cli-docs-and-migration.md`
...
- ExecEd material review (cross-reference; upstream inspiration for future `lamd` analysis commands):
  - `~/mlatcl/execed/cip/cip0002.md` (material review: chapters, talks, snippet freshness)
  - `~/mlatcl/execed/tools/material_review/inventory.py` (include inventory, supports transitive expansion)
  - `~/mlatcl/execed/tools/material_review/snippet_freshness.py` (git-based staleness + ranked refresh candidates)
