...
"""
        ...
        for filename in ["example-diagram.png", "svg-diagram.svg", "diagram-file.png", 
                         "pdf-diagram.pdf", "img-diagram.png"]:
  ...
  pages   = {1--10}
    ...
    def test_extract_diagrams_with_custom_dir(self, mock_print, mock_extract_diagrams):
        ...
        mock_extract_diagrams.return_value = [
            '/path/to/diagrams/example-diagram.png',
            '/path/to/diagrams/svg-diagram.svg'
        ]
    ...
    def test_extract_inputs_with_custom_path(self, mock_print, mock_extract_inputs):
        ...
        mock_extract_inputs.assert_called_once_with(
            'test.md',
